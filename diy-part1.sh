...
#sed -i '$a src-git bypass https://github.com/garypang13/openwrt-bypass.git' feeds.conf.default
...
git clone https://github.com/garypang13/openwrt-bypass package/lean/luci-app-bypass
